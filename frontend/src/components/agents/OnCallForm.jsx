    ...
    <form onSubmit={handleSubmit} className="space-y-3 overflow-visible" data-testid="oncall-form">
      ...
      <div className="flex gap-2 overflow-visible justify-center">
        <textarea
          ...
          rows={2}
          className="w-[70%] px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 text-slate-900 placeholder:text-slate-400 focus:bg-white focus:border-red-400 focus:ring-2 focus:ring-red-100 outline-none transition-all text-sm resize-none"
        />
