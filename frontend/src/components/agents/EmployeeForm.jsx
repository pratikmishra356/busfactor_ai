    ...
    <form onSubmit={handleSubmit} className="space-y-3 overflow-visible" data-testid="employee-form">
      ...
      <div className="flex gap-2 overflow-visible justify-center">
        ...
        <input
          ...
          className="flex-1 max-w-[60%] h-11 px-4 rounded-xl border border-slate-200 bg-slate-50 text-slate-900 placeholder:text-slate-400 focus:bg-white focus:border-blue-400 focus:ring-2 focus:ring-blue-100 outline-none transition-all text-sm"
        />
